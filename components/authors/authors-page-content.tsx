...
import { RipuCalendarPanel, useRipuTimeline } from "@/components/landing/ripu-calendar"
...
export function AuthorsPageContent() {
  const { active, daysRemaining, allDone } = useRipuTimeline()
      ...
      <section id="dates" className="section-block section-white !pt-0">
        <div className="container-main">
          ...
          <Reveal delay={0.06} className="section-inner">
            <RipuCalendarPanel
              footerLink={{ href: "/soumission", label: "Soumettre une communication" }}
            />
          </Reveal>
        </div>
      </section>
